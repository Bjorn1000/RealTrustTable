      ...
      <div className='row'>
        ...
        <Tabs>
          ...
          <TabPanel>
            ...
            <button className='btn btn-primary' onClick={this.registerAddress}>Register this address</button>   
          </TabPanel>
          :
          <div></div>
          }
          ...
          <h1 style={{paddingTop: '10px'}}>Motion Maker</h1>
            ...
            <button onClick={this.createMotion} className='btn btn-primary'>Submit Motion</button>
